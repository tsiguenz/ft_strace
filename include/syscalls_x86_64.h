...
[16] = { "ioctl", "%s(%u, %u, %lu" },                                          \
[17] = { "pread64", "%s(%lu, \"%lu\", %lu,%ld" },                               \
[18] = { "pwrite64", "%s(%u, \"%lu\", %lu,%ld" },                               \
[19] = { "readv", "%s(%lu, %p, %lu" },                                         \
[20] = { "writev", "%s(%lu, %p, %lu" },                                        \
[21] = { "access", "%s(\"%lu\", %d" },                                          \
[22] = { "pipe", "%s(%p" },                                                    \
...
[54] = { "setsockopt", "%s(%d, %d, %d, \"%lu\", %d" },                          \
[55] = { "getsockopt", "%s(%d, %d, %d, \"%lu\", %p" },                          \
...
[165] = { "mount", "%s(\"%lu\", \"%lu\", \"%lu\", %lu, %p" },                     \
[166] = { "umount2", "%s(\"%lu\", %d" },                                        \
[167] = { "swapon", "%s(\"%lu\", %d" },                                         \
[168] = { "swapoff", "%s(%s" },                                                \
[169] = { "reboot", "%s(%d, %d, %u, %p" },                                     \
[170] = { "sethostname", "%s(\"%lu\", %d" },                                    \
[171] = { "setdomainname", "%s(\"%lu\", %d" },                                  \
[172] = { "iopl", "%s(%u, %p" },                                               \
...
[188] = { "setxattr", "%s(\"%lu\", \"%lu\", %p, %lu, %d" },                      \
[189] = { "lsetxattr", "%s(\"%lu\", \"%lu\", %p, %lu, %d" },                     \
[190] = { "fsetxattr", "%s(%d, \"%lu\", %p, %lu, %d" },                         \
[191] = { "getxattr", "%s(\"%lu\", \"%lu\", %p, %lu" },                          \
[192] = { "lgetxattr", "%s(\"%lu\", \"%lu\", %p, %lu" },                         \
[193] = { "fgetxattr", "%s(%d, %p, %p, %lu" },                                 \
[194] = { "listxattr", "%s(\"%lu\", \"%lu\", %lu" },                             \
[195] = { "llistxattr", "%s(\"%lu\", \"%lu\", %lu" },                            \
[196] = { "flistxattr", "%s(%d, \"%lu\", %lu" },                                \
[197] = { "removexattr", "%s(\"%lu\", %s" },                                    \
[198] = { "lremovexattr", "%s(\"%lu\", %s" },                                   \
...
[240] = { "mq_open", "%s(\"%lu\", %d, %u, %p" },                                \
[241] = { "mq_unlink", "%s(%s" },                                              \
[242] = { "mq_timedsend", "%s(%d, \"%lu\", %lu, %u, %p" },                      \
[243] = { "mq_timedreceive", "%s(%d, \"%lu\", %lu, %p, %p" },                   \
[244] = { "mq_notify", "%s(%d, %p" },                                          \
[245] = { "mq_getsetattr", "%s(%d, %p, %p" },                                  \
[246] = { "kexec_load", "%s(%lu, %lu, %p, %lu" },                              \
[247] = { "waitid", "%s(%d, %d, %p, %d, %p" },                                 \
[248] = { "add_key", "%s(\"%lu\", \"%lu\", %p, %lu" },                           \
[249] = { "request_key", "%s(\"%lu\", \"%lu\", \"%lu\", %d" },                    \
[250] = { "keyctl", "%s(%d, %lu, %lu, %lu, %lu" },                             \
[251] = { "ioprio_set", "%s(%d, %d, %d" },                                     \
[252] = { "ioprio_get", "%s(%d, %d" },                                         \
[253] = { "inotify_init", "%s(" },                                             \
[254] = { "inotify_add_watch", "%s(%d, \"%lu\", %u" },                          \
[255] = { "inotify_rm_watch", "%s(%d, %d" },                                   \
[256] = { "migrate_pages", "%s(%d, %lu, %p, %p" },                             \
[257] = { "openat", "%s(%d, \"%lu\", %d, %d" },                                 \
[258] = { "mkdirat", "%s(%d, \"%lu\", %d" },                                    \
[259] = { "mknodat", "%s(%d, \"%lu\", %d, %d" },                                \
[260] = { "fchownat", "%s(%d, \"%lu\", %d, %d, %d" },                           \
[261] = { "futimesat", "%s(%d, \"%lu\", %p" },                                  \
[262] = { "newfstatat", "%s(%d, \"%lu\", %p, %d" },                             \
[263] = { "unlinkat", "%s(%d, \"%lu\", %d" },                                   \
[264] = { "renameat", "%s(%d, \"%lu\", %d, %s" },                               \
[265] = { "linkat", "%s(%d, \"%lu\", %d, \"%lu\", %d" },                         \
[266] = { "symlinkat", "%s(\"%lu\", %d, %s" },                                  \
[267] = { "readlinkat", "%s(%d, \"%lu\", \"%lu\", %d" },                         \
[268] = { "fchmodat", "%s(%d, \"%lu\", %u" },                                   \
[269] = { "faccessat", "%s(%d, \"%lu\", %d" },                                  \
...
[303] = { "name_to_handle_at", "%s(%d, \"%lu\", %p, %p, %d" },                  \
[304] = { "open_by_handle_at", "%s(%d, \"%lu\", %p, %p, %d" },                  \
...
[313] = { "finit_module", "%s(%d, \"%lu\", %d" },                               \
[314] = { "sched_setattr", "%s(%d, %p, %u" },                                  \
[315] = { "sched_getattr", "%s(%d, %p, %u, %u" },                              \
[316] = { "renameat2", "%s(%d, \"%lu\", %d, \"%lu\", %u" },                      \
[317] = { "seccomp", "%s(%u, %u, %s" },                                        \
[318] = { "getrandom", "%s(\"%lu\", %lu, %u" },                                 \
[319] = { "memfd_create", "%s(\"%lu\", %u" },                                   \
[320] = { "kexec_file_load", "%s(%d, %d, %lu, \"%lu\", %lu" },                  \
[321] = { "bpf", "%s(%d, union %p, %u" },                                      \
[322] = { "stub_execveat", "%s(%d, \"%lu\", %p, %p, %d" },                      \
[323] = { "userfaultfd", "%s(%d" },                                            \
