...
[52] = { "umount2", "%s(?, ?, ?, ?, ?, ?" },                                   \
[53] = { "lock", "%s(?, ?, ?, ?, ?, ?" },                                      \
[54] = { "ioctl", "%s(0x%lx, 0x%lx, 0x%lx" },                                  \
[55] = { "fcntl", "%s(0x%lx, 0x%lx, 0x%lx" },                                  \
[56] = { "mpx", "%s(?, ?, ?, ?, ?, ?" },                                       \
[57] = { "setpgid", "%s(%d, %d" },                                             \
[58] = { "ulimit", "%s(?, ?, ?, ?, ?, ?" },                                    \
[59] = { "oldolduname", "%s(?, ?, ?, ?, ?, ?" },                               \
...
[75] = { "setrlimit", "%s(0x%lx, %p" },                                        \
[76] = { "getrlimit", "%s(0x%lx, %p" },                                        \
[77] = { "getrusage", "%s(%d, %p" },                                           \
...
[86] = { "uselib", "%s(\"%s\"" },                                              \
[87] = { "swapon", "%s(\"%s\", %d" },                                          \
[88] = { "reboot", "%s(%d, %d, 0x%lx, %p" },                                   \
[89] = { "readdir", "%s(?, ?, ?, ?, ?, ?" },                                   \
[90] = { "mmap", "%s(?, ?, ?, ?, ?, ?" },                                      \
[91] = { "munmap", "%s(0x%lx, %d" },                                           \
[92] = { "truncate", "%s(\"%s\", 0x%lx" },                                     \
[93] = { "ftruncate", "%s(0x%lx, 0x%lx" },                                     \
[94] = { "fchmod", "%s(0x%lx, %d" },                                           \
[95] = { "fchown", "%s(0x%lx, %d, %d" },                                       \
[96] = { "getpriority", "%s(%d, %d" },                                         \
[97] = { "setpriority", "%s(%d, %d, %d" },                                     \
[98] = { "profil", "%s(?, ?, ?, ?, ?, ?" },                                    \
[99] = { "statfs", "%s(\"%s\", %p" },                                          \
[100] = { "fstatfs", "%s(0x%lx, %p" },                                         \
...
[115] = { "swapoff", "%s(\"%s\"" },                                            \
[116] = { "sysinfo", "%s(%p" },                                                \
[117] = { "ipc", "%s(0x%lx, %d, 0x%lx, 0x%lx, %p, 0x%lx" },                    \
[118] = { "fsync", "%s(0x%lx" },                                               \
[119] = { "sigreturn", "%s(?, ?, ?, ?, ?, ?" },                                \
...
[129] = { "delete_module", "%s(\"%s\", 0x%lx" },                               \
[130] = { "get_kernel_syms", "%s(?, ?, ?, ?, ?, ?" },                          \
[131] = { "quotactl", "%s(0x%lx, \"%s\", 0x%lx, %p" },                         \
[132] = { "getpgid", "%s(%d" },                                                \
[133] = { "fchdir", "%s(0x%lx" },                                              \
[134] = { "bdflush", "%s(%d, 0x%lx" },                                         \
[135] = { "sysfs", "%s(%d, 0x%lx, 0x%lx" },                                    \
[136] = { "personality", "%s(0x%lx" },                                         \
[137] = { "afs_syscall", "%s(?, ?, ?, ?, ?, ?" },                              \
[138] = { "setfsuid", "%s(%d" },                                               \
[139] = { "setfsgid", "%s(%d" },                                               \
[140] = { "_llseek", "%s(?, ?, ?, ?, ?, ?" },                                  \
[141] = { "getdents", "%s(0x%lx, %p, 0x%lx" },                                 \
[142] = { "_newselect", "%s(?, ?, ?, ?, ?, ?" },                               \
[143] = { "flock", "%s(0x%lx, 0x%lx" },                                        \
[144] = { "msync", "%s(0x%lx, %d, %d" },                                       \
[145] = { "readv", "%s(0x%lx, %p, 0x%lx" },                                    \
[146] = { "writev", "%s(0x%lx, %p, 0x%lx" },                                   \
[147] = { "getsid", "%s(%d" },                                                 \
[148] = { "fdatasync", "%s(0x%lx" },                                           \
[149] = { "_sysctl", "%s(?, ?, ?, ?, ?, ?" },                                  \
[150] = { "mlock", "%s(0x%lx, %d" },                                           \
...
[180] = { "pread64", "%s(0x%lx, \"%s\", %d, %d" },                             \
[181] = { "pwrite64", "%s(0x%lx, \"%s\", %d, %d" },                            \
[182] = { "chown", "%s(\"%s\", %d, %d" },                                      \
...
[220] = { "getdents64", "%s(0x%lx, %p, 0x%lx" },                               \
[221] = { "fcntl64", "%s(0x%lx, 0x%lx, 0x%lx" },                               \
...
[241] = { "sched_setaffinity", "%s(%d, 0x%lx, %p" },                           \
[242] = { "sched_getaffinity", "%s(%d, 0x%lx, %p" },                           \
...
[278] = { "mq_unlink", "%s(\"%s\"" },                                          \
[279] = { "mq_timedsend", "%s(0x%lx, \"%s\", %d, 0x%lx, %p" },                 \
...
[309] = { "ppoll", "%s(%p, 0x%lx, %p, %p, %d" },                               \
[310] = { "unshare", "%s(0x%lx" },                                             \
[311] = { "set_robust_list", "%s(%p, %d" },                                    \
[312] = { "get_robust_list", "%s(%d, %p, %p" },                                \
[313] = { "splice", "%s(%d, %p, %d, %p, %d, 0x%lx" },                          \
[314] = { "sync_file_range", "%s(%d, %d, %d, 0x%lx" },                         \
[315] = { "tee", "%s(%d, %d, %d, 0x%lx" },                                     \
[316] = { "vmsplice", "%s(%d, %p, 0x%lx, 0x%lx" },                             \
...
[328] = { "eventfd2", "%s(0x%lx, %d" },                                        \
[329] = { "epoll_create1", "%s(%d" },                                          \
[330] = { "dup3", "%s(0x%lx, 0x%lx, %d" },                                     \
[331] = { "pipe2", "%s(%p, %d" },                                              \
...
[337] = { "recvmmsg", "%s(%d, %p, 0x%lx, 0x%lx, %p" },                         \
[338] = { "fanotify_init", "%s(0x%lx, 0x%lx" },                                \
[339] = { "fanotify_mark", "%s(%d, 0x%lx, 0x%lx, %d, \"%s\"" },                \
[340] = { "prlimit64", "%s(%d, 0x%lx, %p, %p" },                               \
[341] = { "name_to_handle_at", "%s(%d, \"%s\", %p, %p, %d" },                  \
[342] = { "open_by_handle_at", "%s(%d, %p, %d" },                              \
[343] = { "clock_adjtime", "%s(0x%lx, %p" },                                   \
[344] = { "syncfs", "%s(%d" },                                                 \
[345] = { "sendmmsg", "%s(%d, %p, 0x%lx, 0x%lx" },                             \
[346] = { "setns", "%s(%d, %d" },                                              \
...
[351] = { "sched_setattr", "%s(%d, %p, 0x%lx" },                               \
[352] = { "sched_getattr", "%s(%d, %p, 0x%lx, 0x%lx" },                        \
[353] = { "renameat2", "%s(%d, \"%s\", %d, \"%s\", 0x%lx" },                   \
[354] = { "seccomp", "%s(0x%lx, 0x%lx, %p" },                                  \
[355] = { "getrandom", "%s(\"%s\", %d, 0x%lx" },                               \
[356] = { "memfd_create", "%s(\"%s\", 0x%lx" },                                \
[357] = { "bpf", "%s(%d, %p, 0x%lx" },                                         \
...
[377] = { "copy_file_range", "%s(%d, %p, %d, %p, %d, 0x%lx" },                 \
